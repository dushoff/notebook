...
if __name__ == '__main__':
	# Example function call; change 'aa_table.tsv' to your file.
	# By default shows only dividing lines.
	draw_codon_grid_from_tsv('aaTable.tsv', outfile='aaTable.svg')
